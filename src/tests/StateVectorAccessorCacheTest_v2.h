...
class StateVectorAccessorTest_v2 : public CxxTest::TestSuite
{
private:
	...
	std::shared_ptr<StateVectorAccessorCache_v2> cache;
...
public:
    ...
    void setUp(void)
    {
		...
		cache = std::make_shared<StateVectorAccessorCache_v2>(p);
		cache->setup(p);
    }
